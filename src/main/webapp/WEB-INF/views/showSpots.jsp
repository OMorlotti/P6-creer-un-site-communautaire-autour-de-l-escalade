    ...
    <div class="card-body">
        <form method="POST" action="/Escalade/spot">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control form-control-sm" type="text" name="latitude" minlength="6" id="latitude" required="required" />
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label" for="longitude">Longitude :</label>
                <div class="col-sm-10">
                    <input class="form-control form-control-sm" type="text" name="longitude" minlength="6" id="longitude" required="required" />
                </div>
            </div>
            <div class="form-group row">
